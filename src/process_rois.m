...
%% Write the REDCap fields to file
...
for r = 1:length(roilist)
	eval(['infostring = [infostring ' ...
		'sprintf(''namri_' roilist{r} '_mean_raw=%0.4f\n'',namri_' roilist{r} '_mean_raw)];'])
	eval(['infostring = [infostring ' ...
		'sprintf(''namri_' roilist{r} '_median_raw=%0.4f\n'',namri_' roilist{r} '_median_raw)];'])
	eval(['infostring = [infostring ' ...
		'sprintf(''namri_' roilist{r} '_mode_raw=%0.4f\n'',namri_' roilist{r} '_mode_raw)];'])
	eval(['infostring = [infostring ' ...
		'sprintf(''namri_' roilist{r} '_stddev_raw=%0.4f\n'',namri_' roilist{r} '_stddev_raw)];'])
	eval(['infostring = [infostring ' ...
		'sprintf(''namri_' roilist{r} '_mean_mm=%0.4f\n'',namri_' roilist{r} '_mean_mm)];'])
	eval(['infostring = [infostring ' ...
		'sprintf(''namri_' roilist{r} '_median_mm=%0.4f\n'',namri_' roilist{r} '_median_mm)];'])
	eval(['infostring = [infostring ' ...
		'sprintf(''namri_' roilist{r} '_mode_mm=%0.4f\n'',namri_' roilist{r} '_mode_mm)];'])
	eval(['infostring = [infostring ' ...
		'sprintf(''namri_' roilist{r} '_stddev_mm=%0.4f\n'',namri_' roilist{r} '_stddev_mm)];'])
end


redcap_file = fullfile(roi_p,'process_rois_redcap_data.txt');
fid = fopen(redcap_file,'wt');
